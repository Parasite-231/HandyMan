...
<head>
    ...
    <link rel="stylesheet" href="edashboarddesign.css">
...
<body>
    ...
    <div class="side-menu">
        ...
        <ul>
            <li><a href="dashboard.php"><img src="dashboard5.png" alt="dashboard"> &nbsp; Dashboard</a></li>
            <li><a href="employeeProfile.php"><img src="user.png" alt="profile">&nbsp; Profile</a></li>
