            ...
            <div class="sales-boxes">
                <div class="recent-sales box">
                    ...
                    <div class="card">
                        ...
                        <!--start of message portion in card -->
                        <h2 style="margin-top: 20px;">Employee ID: </h2>
                        <p style="margin-top: 20px;justify-content: space-between;">This is your last warning. If you do it again you will be banned</p>
